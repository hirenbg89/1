	...
	$(document).ready(function() {
		...
		$('#buttonStyle').change(function(){
			...
			if(styleValue==2)
			{
				...
				$('#borderRadius').val(cssbuttongenerator.styles.borderRadius);
				$('#palette26').trigger('click');
				cssbuttongenerator.setStyles();
			}
			if(styleValue==3)
			{
				$('.bordercorner').attr('checked','');
				$('#radiusBottomLeft').attr('checked','checked');
				$('#radiusBottomRight').attr('checked','checked');
				cssbuttongenerator.styles.borderRadius = '42px';
				$('#setting-borderRadius').slider('value', 42);
				$('#borderRadius').val(cssbuttongenerator.styles.borderRadius);
			...
			if(styleValue==4)
			{
				...
				$('#widthX').val(cssbuttongenerator.styles.widthX);
				cssbuttongenerator.styles.heightY = '100px';
				$('#setting-heightY').slider('value', 100);
